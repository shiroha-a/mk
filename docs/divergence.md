...
- 基準: **mk-go 1.3.0** ⇔ Misskey TS `2026.9.1`
- 最終更新: 2026-09-23
...
> 混じりうるので、乖離を判断するときは対象の実装を現 pin (`2026.9.1-mk.0`) で確認すること。
...
| config キー | 20 前後 | 0 | — |
| fork frontend の独自変更 | 118 tag (`2026.7.0-mk.0` ～ `2026.9.1-mk.0`) | — | — |
...
**現在の pin は `2026.9.1-mk.0` (`bf94735a`)。** `2026.9.0-mk.*` の行はすべて 2026.9.1 への
