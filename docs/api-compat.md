...
| POST | `/api/admin/emoji-application/list-by-user` |
| POST | `/api/admin/emoji-application/reject` |
| POST | `/api/admin/emoji-application/related` |
...
| POST | `/api/admin/roles/assignment-show` |
| POST | `/api/admin/self-check` |
| POST | `/api/admin/server-metrics` |
| POST | `/api/admin/server-plugins` |
