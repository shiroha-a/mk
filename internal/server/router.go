...
func (s *Server) setupRoutes() {
	...
	api.POST("/notes/create", notesHandler.Create, middleware.RequireAuth(), middleware.RequireScope("write:notes"))
	...
	api.POST("/notes/reactions/create", notesHandler.ReactionsCreate, middleware.RequireAuth(), middleware.RequireScope("write:reactions"))
	...
	api.POST("/notes/polls/vote", notesHandler.PollsVote, middleware.RequireAuth(), middleware.RequireScope("write:votes"))
	// Notes extra endpoints (Phase 6)
	notesHandler.SetFavoriteRepo(noteFavoriteRepo)
	api.POST("/notes/favorites/create", notesHandler.FavoritesCreate, middleware.RequireAuth(), middleware.RequireScope("write:favorites"))
	...
	api.POST("/notes/drafts/list", notesHandler.DraftsList, middleware.RequireAuth(), middleware.RequireScope("read:account"))
	api.POST("/notes/drafts/create", notesHandler.DraftsCreate, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	api.POST("/notes/drafts/update", notesHandler.DraftsUpdate, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	api.POST("/notes/drafts/delete", notesHandler.DraftsDelete, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	api.POST("/notes/drafts/count", notesHandler.DraftsCount, middleware.RequireAuth(), middleware.RequireScope("read:account"))
	...
	api.POST("/users/lists/create-from-public", usersHandler.ListsCreateFromPublic, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	...
	api.POST("/users/lists/update-membership", usersHandler.ListsUpdateMembership, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	...
	api.POST("/i/pin", iHandler.Pin, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	...
	api.POST("/gallery/posts/create", galleryHandler.PostsCreate, middleware.RequireAuth(), middleware.RequireScope("write:gallery"))
	...
	api.POST("/gallery/posts/update", galleryHandler.PostsUpdate, middleware.RequireAuth(), middleware.RequireScope("write:gallery"))
	api.POST("/gallery/posts/like", galleryHandler.PostsLike, middleware.RequireAuth(), middleware.RequireScope("write:gallery-likes"))
	api.POST("/gallery/posts/unlike", galleryHandler.PostsUnlike, middleware.RequireAuth(), middleware.RequireScope("write:gallery-likes"))
	...
	api.POST("/mute/create", muteHandler.Create, middleware.RequireAuth(), middleware.RequireScope("write:mutes"))
	...
	api.POST("/renote-mute/create", renoteMuteHandler.Create, middleware.RequireAuth(), middleware.RequireScope("write:mutes"))
	...
	api.POST("/drive/files/create", driveHandler.FilesCreate, middleware.RequireAuth(), middleware.RequireScope("write:drive"))
	...
	api.POST("/drive/files/upload-from-url", driveHandler.FilesUploadFromURL, middleware.RequireAuth(), middleware.RequireScope("write:drive"))
	...
	api.POST("/channels/follow", channelsHandler.Follow, middleware.RequireAuth(), middleware.RequireScope("write:channels"))
	api.POST("/channels/unfollow", channelsHandler.Unfollow, middleware.RequireAuth(), middleware.RequireScope("write:channels"))
	...
	api.POST("/antennas/create", antennasHandler.Create, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	api.POST("/antennas/show", antennasHandler.Show, middleware.RequireAuth(), middleware.RequireScope("read:account"))
	api.POST("/antennas/update", antennasHandler.Update, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	...
	api.POST("/pages/like", pagesHandler.Like, middleware.RequireAuth(), middleware.RequireScope("write:page-likes"))
	api.POST("/pages/unlike", pagesHandler.Unlike, middleware.RequireAuth(), middleware.RequireScope("write:page-likes"))
	...
	api.POST("/flash/create", flashHandler.Create, middleware.RequireAuth(), middleware.RequireScope("write:flash"))
	api.POST("/flash/show", flashHandler.Show)
	api.POST("/flash/update", flashHandler.Update, middleware.RequireAuth(), middleware.RequireScope("write:flash"))
	...
	api.POST("/flash/like", flashHandler.Like, middleware.RequireAuth(), middleware.RequireScope("write:flash-likes"))
	api.POST("/flash/unlike", flashHandler.Unlike, middleware.RequireAuth(), middleware.RequireScope("write:flash-likes"))
	...
	// channels 残り
	api.POST("/channels/favorite", channelsHandler.Favorite, middleware.RequireAuth(), middleware.RequireScope("write:channels"))
	api.POST("/channels/unfavorite", channelsHandler.Unfavorite, middleware.RequireAuth(), middleware.RequireScope("write:channels"))
	api.POST("/channels/mute/create", channelsHandler.MuteCreate, middleware.RequireAuth(), middleware.RequireScope("write:channels"))
	api.POST("/channels/mute/delete", channelsHandler.MuteDelete, middleware.RequireAuth(), middleware.RequireScope("write:channels"))
	...
	api.POST("/users/lists/create", userListHandler.Create, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	api.POST("/users/lists/show", userListHandler.Show, middleware.RequireAuth(), middleware.RequireScope("read:account"))
	api.POST("/users/lists/push", userListHandler.Push, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	api.POST("/users/lists/pull", userListHandler.Pull, middleware.RequireAuth(), middleware.RequireScope("write:account"))
	...
	api.POST("/chat/rooms/invitations/create", chatHandler.InvitationsCreate, middleware.RequireAuth(), middleware.RequireScope("write:chat"))
	...
	api.POST("/chat/messages/create-to-user", chatHandler.MessagesCreateToUser, middleware.RequireAuth(), middleware.RequireScope("write:chat"))
	api.POST("/chat/messages/create-to-room", chatHandler.MessagesCreateToRoom, middleware.RequireAuth(), middleware.RequireScope("write:chat"))
