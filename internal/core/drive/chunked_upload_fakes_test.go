...
func (f *mockMultipartStorage) CompleteMultipartUpload(_ context.Context, accessKey, uploadID string, parts []drive.UploadedPart) (string, error) {
...
var _ drive.MultipartStorage = (*mockMultipartStorage)(nil)
var _ drive.Storage = (*mockMultipartStorage)(nil)
